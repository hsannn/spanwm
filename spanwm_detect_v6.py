"""SpanWM v6 detection + metrics (multi-span pooled test).
...
Run:
    python spanwm_detect_v6.py --input outputs/spanwm_v6_c4_n200.jsonl
    python spanwm_detect_v6.py --input outputs/spanwm_v6_c4_n200.jsonl --negative natural
"""
...
def main() -> None:
    ...
    print(f"samples         : {n}   negative class: {args.negative}   [v6: multi-span pooled]")
