"""SpanWM v7 embedding: multi-span (several small watermarked windows).

Same flow as spanwm_embed_v6.py but uses SpanWMV7. v3/v4/v5/v6 files untouched.

Run (GPU node, dlmwm env):
    python spanwm_embed_v7.py --dataset c4 --num_samples 200
"""
...
def main() -> None:
    ...
    output = args.output or f"outputs/spanwm_v7_{args.dataset}_n{args.num_samples}.jsonl"
