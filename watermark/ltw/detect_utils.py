...
from transformers import LogitsProcessor,AutoModelForCausalLM,AutoTokenizer,AutoModel
from .selector_network import SelectorNetwork

from nltk.util import ngrams

# part of this code is copied from https://github.com/hongcheki/sweet-watermark/blob/master/watermark.py and https://github.com/jwkirchenbauer/lm-watermarking/blob/main/watermark_processor.py
#  modified for our watermarking
...
class WatermarkDetector(WatermarkBase):
    def __init__(
        ...
        **kwargs,
        ...
        self.selector_network.to(self.device)
        self.semantic_model = AutoModel.from_pretrained(semantic_model_path).to(self.device)
    ...
    def calculate_entropy(self,model, tokenized_text):
        with torch.no_grad():
